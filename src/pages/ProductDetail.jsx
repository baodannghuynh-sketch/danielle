...
export default function ProductDetail() {
  ...
  const { addItem, addRecentViewed, toggleWishlist, wishlist } = useCartStore();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '60px 0' }}>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <p style={{ fontSize: '20px', margin: '8px 0 0' }}>
                Vàng {product.material || '18K'} nguyên khối • Kim cương tự nhiên GIA
              </p>
            </div>
          ...
          {/* phần 5 của bạn giữ nguyên */}
          {/* … PHẦN UPSALE (tôi không chỉnh) … */}
